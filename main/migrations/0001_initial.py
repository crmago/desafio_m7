    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precios', models.IntegerField(null=True, validators=[django.core.validators.MinValueValidator(1000)])),
                ('precios_ufs', models.FloatField(null=True, validators=[django.core.validators.MinValueValidator(1.0)])),
        ...
        migrations.AddField(
            model_name='comuna',
            name='region',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comunas', to='main.region'),
        ),
        migrations.CreateModel(
            name='Solicitud',
            fields=[
